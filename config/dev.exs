...
config :x_budget, XBudgetWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "D14h1cVJbigNFhtY92Hch9gHXepsJDWl7F+hhmnr7YN8/ThPA+NRIaDcwG/b1gTc",
  watchers: [
...
config :x_budget, XBudgetWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/x_budget_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :x_budget, dev_routes: true
